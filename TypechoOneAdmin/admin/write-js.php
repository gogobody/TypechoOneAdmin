...
<script src="<?php echo $options->pluginUrl . '/TypechoOneAdmin/admin_js/timepicker.js?v=' . $suffixVersion;?>"></script>
<script src="<?php echo $options->pluginUrl . '/TypechoOneAdmin/admin_js/tokeninput.js?v=' . $suffixVersion;?>"></script>
<script>
