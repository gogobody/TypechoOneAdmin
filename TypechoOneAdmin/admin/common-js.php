...
<script src="<?php echo $options->pluginUrl . '/TypechoOneAdmin/admin_js/jquery.js?v=' . $suffixVersion; ?>"></script>
<script src="<?php echo $options->pluginUrl . '/TypechoOneAdmin/admin_js/jquery-ui.js?v=' . $suffixVersion; ?>"></script>
<script src="<?php echo $options->pluginUrl . '/TypechoOneAdmin/admin_js/typecho.js?v=' . $suffixVersion;?>"></script>
<script>
    (function () {
