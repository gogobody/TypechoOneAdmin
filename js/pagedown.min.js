...
d.strings=d.strings||{};d.helpButton&&(d.strings.help=d.strings.help||d.helpButton.title);var e=function(x){var m=d.strings[x]||ea[x];if("imagename"==x||"linkname"==x)d.strings[x]=null;return m};c=c||"";var g=this.hooks=new Markdown.HookCollection;g.addNoop("onPreviewRefresh");g.addNoop("postBlockquoteCreation");g.addFalse("insertImageDialog");g.addFalse("insertLinkDialog");g.addNoop("makeButton");g.addNoop("commandExecuted");g.addNoop("enterFullScreen");g.addNoop("enterFakeFullScreen");g.addNoop("exitFullScreen");
this.getConverter=function(){return a};var n=this,l;this.run=function(){if(!l){l=new da(c);var x=new U(g,e),m=new E(a,l,function(){g.onPreviewRefresh()});if(!/\?noundo/.test(v.location.href)){var u=new Z(function(){m.refresh();q&&q.setUndoRedoButtonStates()},l);this.textOperation=function(w){u.setCommandMode();w();n.refreshPreview()}}fullScreenManager=new N(g,e);var q=new S(c,l,g,u,m,x,fullScreenManager,d.helpButton,e);q.setUndoRedoButtonStates();(n.refreshPreview=function(){m.refresh(!0)})()}}};
T.prototype.findTags=function(a,c){var d=this;if(a){var e=A.extendRegExp(a,"","$");this.before=this.before.replace(e,function(g){d.startTag+=g;return""});e=A.extendRegExp(a,"^","");this.selection=this.selection.replace(e,function(g){d.startTag+=g;return""})}c&&(e=A.extendRegExp(c,"","$"),this.selection=this.selection.replace(e,function(g){d.endTag=g+d.endTag;return""}),e=A.extendRegExp(c,"^",""),this.after=this.after.replace(e,function(g){d.endTag=g+d.endTag;return""}))};T.prototype.trimWhitespace=
function(a){var c,d=this;a?a=c="":(a=function(e){d.before+=e;return""},c=function(e){d.after=e+d.after;return""});this.selection=this.selection.replace(/^(\s*)/,a).replace(/(\s*)$/,c)};T.prototype.skipLines=function(a,c,d){void 0===a&&(a=1);void 0===c&&(c=1);a++;c++;var e,g;navigator.userAgent.match(/Chrome/)&&"X".match(/()./);this.selection=this.selection.replace(/(^\n*)/,"");this.startTag+=K.$1;this.selection=this.selection.replace(/(\n*$)/,"");this.endTag+=K.$1;this.startTag=this.startTag.replace(/(^\n*)/,
"");this.before+=K.$1;this.endTag=this.endTag.replace(/(\n*$)/,"");this.after+=K.$1;if(this.before){for(e=g="";a--;)e+="\\n?",g+="\n";d&&(e="\\n*");this.before=this.before.replace(new K(e+"$",""),g)}if(this.after){for(e=g="";c--;)e+="\\n?",g+="\n";d&&(e="\\n*");this.after=this.after.replace(new K(e,""),g)}};A.isVisible=function(a){if(window.getComputedStyle)return"none"!==window.getComputedStyle(a,null).getPropertyValue("display");if(a.currentStyle)return"none"!==a.currentStyle.display};A.addEvent=
function(a,c,d){a.attachEvent?a.attachEvent("on"+c,d):a.addEventListener(c,d,!1)};A.removeEvent=function(a,c,d){a.detachEvent?a.detachEvent("on"+c,d):a.removeEventListener(c,d,!1)};A.fixEolChars=function(a){a=a.replace(/\r\n/g,"\n");return a=a.replace(/\r/g,"\n")};A.extendRegExp=function(a,c,d){if(null===c||void 0===c)c="";if(null===d||void 0===d)d="";a=a.toString();var e;a=a.replace(/\/([gim]*)$/,function(g,n){e=n;return""});a=a.replace(/(^\/|\/$)/g,"");return new K(c+a+d,e)};R.getTop=function(a,
c){var d=a.offsetTop;if(!c)for(;a=a.offsetParent;)d+=a.offsetTop;return d};R.getHeight=function(a){return a.offsetHeight||a.scrollHeight};R.getWidth=function(a){return a.offsetWidth||a.scrollWidth};R.getPageSize=function(){if(self.innerHeight&&self.scrollMaxY){var a=v.body.scrollWidth;var c=self.innerHeight+self.scrollMaxY}else v.body.scrollHeight>v.body.offsetHeight?(a=v.body.scrollWidth,c=v.body.scrollHeight):(a=v.body.offsetWidth,c=v.body.offsetHeight);if(self.innerHeight){var d=self.innerWidth;
var e=self.innerHeight}else v.documentElement&&v.documentElement.clientHeight?(d=v.documentElement.clientWidth,e=v.documentElement.clientHeight):v.body&&(d=v.body.clientWidth,e=v.body.clientHeight);return[Math.max(a,d),Math.max(c,e),d,e]};O.createBackground=function(){var a=v.createElement("div"),c=a.style;a.className="wmd-prompt-background";c.position="absolute";c.top="0";c.zIndex="1000";P.isIE?c.filter="alpha(opacity=50)":c.opacity="0.5";var d=R.getPageSize();c.height=d[1]+"px";P.isIE?(c.left=v.documentElement.scrollLeft,
c.width=v.documentElement.clientWidth):(c.left="0",c.width="100%");v.body.appendChild(a);return a};O.dialog=function(a,c,d,e){var g,n=function(m){27===(m.charCode||m.keyCode)&&l(!0)},l=function(m){A.removeEvent(v.body,"keydown",n);g.parentNode.removeChild(g);c(m);return!1},x=function(){g=v.createElement("div");g.className="wmd-prompt-dialog";g.setAttribute("role","dialog");var m=v.createElement("div"),u=v.createElement("form");u.onsubmit=function(){return l(!1)};g.appendChild(u);u.appendChild(m);
"function"==typeof a?a.call(this,m):m.innerHTML=a;m=v.createElement("button");m.type="button";m.className="btn btn-s primary";m.onclick=function(){return l(!1)};m.innerHTML=d;var q=v.createElement("button");q.type="button";q.className="btn btn-s";q.onclick=function(){return l(!0)};q.innerHTML=e;u.appendChild(m);u.appendChild(q);A.addEvent(v.body,"keydown",n);v.body.appendChild(g)};setTimeout(function(){x()},0)};O.prompt=function(a,c,d,e,g){var n,l;void 0===c&&(c="");var x=function(q){27===(q.charCode||
q.keyCode)&&m(!0)},m=function(q){A.removeEvent(v.body,"keydown",x);var w=l.value;q?w=null:(w=w.replace(/^http:\/\/(https?|ftp):\/\//,"$1://"),/^(?:https?|ftp):\/\//.test(w)||/^[_a-z0-9-]+:/i.test(w)||(w="http://"+w));n.parentNode.removeChild(n);d(w);return!1},u=function(){n=v.createElement("div");n.className="wmd-prompt-dialog";n.setAttribute("role","dialog");var q=v.createElement("div");q.innerHTML=a;n.appendChild(q);q=v.createElement("form");q.onsubmit=function(){return m(!1)};n.appendChild(q);
l=v.createElement("input");l.type="text";l.value=c;q.appendChild(l);var w=v.createElement("button");w.type="button";w.className="btn btn-s primary";w.onclick=function(){return m(!1)};w.innerHTML=e;var F=v.createElement("button");F.type="button";F.className="btn btn-s";F.onclick=function(){return m(!0)};F.innerHTML=g;q.appendChild(w);q.appendChild(F);A.addEvent(v.body,"keydown",x);v.body.appendChild(n)};setTimeout(function(){u();var q=c.length;if(void 0!==l.selectionStart)l.selectionStart=0,l.selectionEnd=
q;else if(l.createTextRange){var w=l.createTextRange();w.collapse(!1);w.moveStart("character",-q);w.moveEnd("character",q);w.select()}l.focus()},0)};var I=U.prototype;I.prefixes="(?:\\s{4,}|\\s*>|\\s*-\\s+|\\s*\\d+\\.|=|\\+|-|_|\\*|#|\\s*\\[[^\n]]+\\]:)";I.unwrap=function(a){var c=new K("([^\\n])\\n(?!(\\n|"+this.prefixes+"))","g");a.selection=a.selection.replace(c,"$1 $2")};I.wrap=function(a,c){this.unwrap(a);c=new K("(.{1,"+c+"})( +|$\\n?)","gm");var d=this;a.selection=a.selection.replace(c,function(e,
g){return(new K("^"+d.prefixes,"")).test(e)?e:g+"\n"});a.selection=a.selection.replace(/\s+$/,"")};I.doBold=function(a,c){return this.doBorI(a,c,2,this.getString("boldexample"))};I.doItalic=function(a,c){return this.doBorI(a,c,1,this.getString("italicexample"))};I.doBorI=function(a,c,d,e){a.trimWhitespace();a.selection=a.selection.replace(/\n{2,}/g,"\n");var g=/(\**$)/.exec(a.before)[0];c=/(^\**)/.exec(a.after)[0];g=Math.min(g.length,c.length);g>=d&&(2!=g||1!=d)?(a.before=a.before.replace(K("[*]{"+
d+"}$",""),""),a.after=a.after.replace(K("^[*]{"+d+"}",""),"")):!a.selection&&c?(a.after=a.after.replace(/^([*_]*)/,""),a.before=a.before.replace(/(\s?)$/,""),a.before=a.before+c+K.$1):(a.selection||c||(a.selection=e),d=1>=d?"*":"**",a.before+=d,a.after=d+a.after)};I.stripLinkDefs=function(a,c){return a=a.replace(/^[ ]{0,3}\[(\d+)\]:[ \t]*\n?[ \t]*<?(\S+?)>?[ \t]*\n?[ \t]*(?:(\n*)["(](.+?)[")][ \t]*)?(?:\n+|$)/gm,function(d,e,g,n,l){c[e]=d.replace(/\s*$/,"");return n?(c[e]=d.replace(/["(](.+?)[")]$/,
""),n+l):""})};I.addLinkDef=function(a,c){var d=0,e={};a.before=this.stripLinkDefs(a.before,e);a.selection=this.stripLinkDefs(a.selection,e);a.after=this.stripLinkDefs(a.after,e);var g="",n=/(\[)((?:\[[^\]]*\]|[^\[\]])*)(\][ ]?(?:\n[ ]*)?\[)(\d+)(\])/g,l=function(m){d++;m=m.replace(/^[ ]{0,3}\[(\d+)\]:/,"  ["+d+"]:");g+="\n"+m},x=function(m,u,q,w,F,J){q=q.replace(n,x);return e[F]?(l(e[F]),u+q+w+d+J):m};a.before=a.before.replace(n,x);c?l(c):a.selection=a.selection.replace(n,x);c=d;a.after=a.after.replace(n,
x);a.after&&(a.after=a.after.replace(/\n*$/,""));a.after||(a.selection=a.selection.replace(/\n*$/,""));a.after+="\n\n"+g;return c};I.doLinkOrImage=function(a,c,d){a.trimWhitespace();a.findTags(/\s*!?\[/,/\][ ]?(?:\n[ ]*)?(\[.*?\])?/);if(1<a.endTag.length&&0<a.startTag.length)a.startTag=a.startTag.replace(/!?\[/,""),a.endTag="",this.addLinkDef(a,null);else if(a.selection=a.startTag+a.selection+a.endTag,a.startTag=a.endTag="",/\n\n/.test(a.selection))this.addLinkDef(a,null);else{var e=this,g=function(l){n.parentNode.removeChild(n);
null!==l&&(a.selection=(" "+a.selection).replace(/([^\\](?:\\\\)*)(?=[[\]])/g,"$1\\").substr(1),l=" [999]: "+aa(l),l=e.addLinkDef(a,l),a.startTag=d?"![":"[",a.endTag="]["+l+"]",a.selection||(d?(l=e.getString("imagename"),a.selection=l||e.getString("imagedescription")):(l=e.getString("linkname"),a.selection=l||e.getString("linkdescription"))));c();e.hooks.commandExecuted(d?"doImage":"doLink")};var n=O.createBackground();d?this.hooks.insertImageDialog(g)||O.prompt(this.getString("imagedialog"),"http://",
g,this.getString("ok"),this.getString("cancel")):this.hooks.insertLinkDialog(g)||O.prompt(this.getString("linkdialog"),"http://",g,this.getString("ok"),this.getString("cancel"));return!0}};I.doAutoindent=function(a,c){c=!1;a.before=a.before.replace(/(\n|^)[ ]{0,3}([*+-]|\d+[.])[ \t]*\n$/,"\n\n");a.before=a.before.replace(/(\n|^)[ ]{0,3}>[ \t]*\n$/,"\n\n");a.before=a.before.replace(/(\n|^)[ \t]+\n$/,"\n\n");a.selection||/^[ \t]*(?:\n|$)/.test(a.after)||(a.after=a.after.replace(/^[^\n]*/,function(d){a.selection=
d;return""}),c=!0);/(\n|^)[ ]{0,3}([*+-]|\d+[.])[ \t]+.*\n$/.test(a.before)&&this.doList&&this.doList(a);/(\n|^)[ ]{0,3}>[ \t]+.*\n$/.test(a.before)&&this.doBlockquote&&this.doBlockquote(a);/(\n|^)(\t|[ ]{4,}).*\n$/.test(a.before)&&this.doCode&&this.doCode(a);c&&(a.after=a.selection+a.after,a.selection="")};I.doBlockquote=function(a,c){a.selection=a.selection.replace(/^(\n*)([^\r]+?)(\n*)$/,function(m,u,q,w){a.before+=u;a.after=w+a.after;return q});a.before=a.before.replace(/(>[ \t]*)$/,function(m,
u){a.selection=u+a.selection;return""});a.selection=a.selection.replace(/^(\s|>)+$/,"");a.selection=a.selection||this.getString("quoteexample");var d=c="";if(a.before){for(var e=a.before.replace(/\n$/,"").split("\n"),g=!1,n=0;n<e.length;n++){var l=!1;var x=e[n];g=g&&0<x.length;/^>/.test(x)?(l=!0,!g&&1<x.length&&(g=!0)):l=/^[ \t]*$/.test(x)?!0:g;l?c+=x+"\n":(d+=c+x,c="\n")}/(^|\n)>/.test(c)||(d+=c,c="")}a.startTag=c;a.before=d;a.after&&(a.after=a.after.replace(/^\n?/,"\n"));a.after=a.after.replace(/^(((\n|^)(\n[ \t]*)*>(.+\n)*.*)+(\n[ \t]*)*)/,
function(m){a.endTag=m;return""});c=function(m){var u=m?"> ":"";a.startTag&&(a.startTag=a.startTag.replace(/\n((>|\s)*)\n$/,function(q,w){return"\n"+w.replace(/^[ ]{0,3}>?[ \t]*$/gm,u)+"\n"}));a.endTag&&(a.endTag=a.endTag.replace(/^\n((>|\s)*)\n/,function(q,w){return"\n"+w.replace(/^[ ]{0,3}>?[ \t]*$/gm,u)+"\n"}))};/^(?![ ]{0,3}>)/m.test(a.selection)?(this.wrap(a,70),a.selection=a.selection.replace(/^/gm,"> "),c(!0),a.skipLines()):(a.selection=a.selection.replace(/^[ ]{0,3}> ?/gm,""),this.unwrap(a),
...
function(e){a.selection=e+a.selection;return""});var d=c=1;/(\n|^)(\t|[ ]{4,}).*\n$/.test(a.before)&&(c=0);/^\n(\t|[ ]{4,})/.test(a.after)&&(d=0);a.skipLines(c,d);a.selection?/^[ ]{0,3}\S/m.test(a.selection)?/\n/.test(a.selection)?a.selection=a.selection.replace(/^/gm,"    "):a.before+="    ":a.selection=a.selection.replace(/^(?:[ ]{4}|[ ]{0,3}\t)/gm,""):(a.startTag="    ",a.selection=this.getString("codeexample"))}else a.trimWhitespace(),a.findTags(/`/,/`/),a.startTag||a.endTag?a.endTag&&!a.startTag?
(a.before+=a.endTag,a.endTag=""):a.startTag=a.endTag="":(a.startTag=a.endTag="`",a.selection||(a.selection=this.getString("codeexample")))};I.doList=function(a,c,d){c=/^\n*(([ ]{0,3}([*+-]|\d+[.])[ \t]+.*)(\n.+|\n{2,}([*+-].*|\d+[.])[ \t]+.*|\n{2,}[ \t]+\S.*)*)\n*/;var e="-",g=1,n=function(){if(d){var q=" "+g+". ";g++}else q=" "+e+" ";return q},l=function(q){void 0===d&&(d=/^\s*\d/.test(q));return q=q.replace(/^[ ]{0,3}([*+-]|\d+[.])\s/gm,function(w){return n()})};a.findTags(/(\n|^)*[ ]{0,3}([*+-]|\d+[.])\s+/,
null);!a.before||/\n$/.test(a.before)||/^\n/.test(a.startTag)||(a.before+=a.startTag,a.startTag="");if(a.startTag){var x=/\d+[.]/.test(a.startTag);a.startTag="";a.selection=a.selection.replace(/\n[ ]{4}/g,"\n");this.unwrap(a);a.skipLines();x&&(a.after=a.after.replace(c,l));if(d==x)return}var m=1;a.before=a.before.replace(/(\n|^)(([ ]{0,3}([*+-]|\d+[.])[ \t]+.*)(\n.+|\n{2,}([*+-].*|\d+[.])[ \t]+.*|\n{2,}[ \t]+\S.*)*)\n*$/,function(q){/^\s*([*+-])/.test(q)&&(e=K.$1);m=/[^\n]\n\n[^\n]/.test(q)?1:0;return l(q)});
a.selection||(a.selection=this.getString("litem"));x=n();var u=1;a.after=a.after.replace(c,function(q){u=/[^\n]\n\n[^\n]/.test(q)?1:0;return l(q)});a.trimWhitespace(!0);a.skipLines(m,u,!0);a.startTag=x;c=x.replace(/./g," ");this.wrap(a,72-c.length);a.selection=a.selection.replace(/\n/g,"\n"+c);this.hooks.commandExecuted("doList")};I.doHeading=function(a,c){a.selection=a.selection.replace(/\s+/g," ");a.selection=a.selection.replace(/(^\s+|\s+$)/g,"");if(a.selection){if(c=0,a.findTags(/#+[ ]*/,/[ ]*#+/),
/#+/.test(a.startTag)&&(c=K.lastMatch.length),a.startTag=a.endTag="",a.findTags(null,/\s?(-+|=+)/),/=+/.test(a.endTag)&&(c=1),/-+/.test(a.endTag)&&(c=2),a.startTag=a.endTag="",a.skipLines(1,1),c=0==c?2:c-1,0<c){c=2<=c?"-":"=";var d=a.selection.length;72<d&&(d=72);for(a.endTag="\n";d--;)a.endTag+=c}}else a.startTag="## ",a.selection=this.getString("headingexample"),a.endTag=" ##"};I.doHorizontalRule=function(a,c){a.startTag="----------\n";a.selection="";a.skipLines(2,1,!0)};I.doMore=function(a,c){a.startTag=
"\x3c!--more--\x3e\n\n";a.selection="";a.skipLines(2,0,!0)};I.doTab=function(a,c){a.startTag="    ";a.selection=""};N.prototype.doFullScreen=function(a,c){var d=Y(),e=this;if(!d)return alert(e.getString("fullscreenUnsupport")),!1;this.fullScreenBind||(A.addEvent(document,d.fullScreenChange.substring(2),function(){V()?(a.fullscreen.style.display="none",a.exitFullscreen.style.display="",e.hooks.enterFullScreen()):(a.fullscreen.style.display="",a.exitFullscreen.style.display="none",e.hooks.exitFullScreen())}),
this.fullScreenBind=!0);if(c)e.isFakeFullScreen?(document.body[d.requestFullscreen]("webkitRequestFullScreen"==d.requestFullscreen?Element.ALLOW_KEYBOARD_INPUT:null),e.isFakeFullScreen=!1):V()||(a.exitFullscreen.style.display="",e.hooks.enterFakeFullScreen(),e.isFakeFullScreen=!0),window.fullScreenEntered=!0;else{if(e.isFakeFullScreen)a.exitFullscreen.style.display="none",e.hooks.exitFullScreen();else if(V())document[d.cancelFullscreen]();e.isFakeFullScreen=!1;window.fullScreenEntered=!1}}})();
